                    ...
                    <form onSubmit={handleSignIn}>
                        <div className="my-10">
                            <button
                                ...
                                className="w-full py-3 border-2 bg-[#8C52FF] text-white"
                                type="submit"
                        ...
                        <div className="flex gap-2 md:gap-5 lg:gap-10 items-center my-10">
                            <div className="relative z-0 group">
                                <button type="submit" className="text-white md:w-full  bg-[#8C52FF]  font-medium rounded-lg text-sm sm:w-auto px-5 py-2.5 text-cent">SIGN IN</button>
                            </div>
                            <div className="relative z-0 group">
                                <Link to={'/signup'}>
                                    <button className="text-white md:w-full  bg-[#8C52FF]  font-medium rounded-lg text-sm sm:w-auto px-5 py-2.5 text-center">SIGN UP</button>
                                </Link>
                            </div>
                        </div>
                    </form>
