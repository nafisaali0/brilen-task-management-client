...
import icon2 from '../../../assets/image/icons/twitter-svgrepo-com.svg'
import icon3 from '../../../assets/image/icons/linkedin.svg'
import icon4 from '../../../assets/image/icons/github1.svg'
                ...
                <div className="navbar container mx-auto">
                    <div className="navbar-start">
                        <div className='flex gap-1 items-center flex-wrap justify-center md:justify-start'>
                            ...
                            <a href=""><img className='w-[30px] h-[30px]' src={icon4} alt="" /></a>
                        </div>
                    </div>
